...
async function getResponse(inputString: string) {
    ...
    const prompt = `
You're going to create a custom chesspiece from an input string. The format of your response should look like the following (a JSON string):
